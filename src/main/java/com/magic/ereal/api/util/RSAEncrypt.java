...
public class RSAEncrypt {
    ...
    private static final String MODLE = "RSA/ECB/PKCS1Padding";
    ...
    public static byte[] encrypt(RSAPublicKey publicKey, byte[] plainTextData)
        ...
        try {
            // 使用默认RSA
            cipher = Cipher.getInstance(MODLE);
    ...
    public static byte[] encrypt(String privateKey, byte[] plainTextData) {
        try {
            RSAPrivateKey rsaPrivateKey = RSAEncrypt.loadPrivateKeyByStr(privateKey);
            return encrypt(rsaPrivateKey, plainTextData);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static void main(String[] args) {
        try {
            String param = "ZRapyMjiKP7eom8lM3dAaAOFeUc7PXWdc0IxSflUbNi8KhmNqHCQpaU+X3CsAs+U+HewV1hXYmSj8b+0Vzkpxy4S9C84ZJY2MF1Yv/dMltF1exQYN0dY1f9+BaLu6Ket 9ObaSRyMqov5fy/pZEJNb3PVdcl10g6HJbgS/BGE70I=";
