...
<body>
    ...
    <script>
        ...
        var userId = YZ.getUrlParam("userId"); // UserID
        ...
        function initData () {
            ...
            var kl = new Array(); //k临时数组
            var kc = new Array(); //k常规数组
            var kt = new Array(); //项目总k数组
            var name = new Array(); //项目总k数组
            var max = 0;
            var arr = {
                time : time,
                timeType : timeType,
            ...
            YZ.ajaxRequestData("post", false, YZ.ip + "/kStatistics/getByTimePersonageMap", arr , userToken , function(result) {
                if (result.flag == 0 && result.code == 200) {
                    ...
                    for (var i = 0; i < kt.length; i++) {
                        ...
                        kl[i] = Number(kl[i]).toFixed(2);
                        kc[i] = Number(kc[i]).toFixed(2);
